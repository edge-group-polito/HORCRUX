...
// Design Name:  Falcon-1024 KAT Test — HORCRUX-Optimized
// Language:     C
// Date:         April 2026
//
// Description:  Self-contained KAT test for Falcon key generation, signing, and
//               verification, adapted from the official NIST reference implementation.
