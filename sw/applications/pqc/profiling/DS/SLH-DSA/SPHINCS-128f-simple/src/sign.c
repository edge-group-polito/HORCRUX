                             ...
                             const unsigned char *seed)
{
    ...
    CSR_READ(CSR_REG_MCYCLE, &cycles_function);
    printf("crypto_sign_seed_keypair memcpy(ctx seeds) cycles: %u\n", cycles_function);
                       ...
                       const uint8_t *m, size_t mlen, const uint8_t *pk)
{
    ...
    if (memcmp(root, pub_root, SPX_N)) {
        CSR_READ(CSR_REG_MCYCLE, &cycles_function);
        printf("crypto_sign_verify memcmp(fail) cycles: %u\n", cycles_function);
        return -1;
    }
    CSR_READ(CSR_REG_MCYCLE, &cycles_function);
    printf("crypto_sign_verify memcmp(pass) cycles: %u\n", cycles_function);
                ...
                const unsigned char *sk, uint8_t *signature_rnd)
{
    ...
    CSR_READ(CSR_REG_MCYCLE, &cycles_function);
    printf("crypto_sign memmove cycles: %u\n", cycles_function);
                     ...
                     const unsigned char *pk)
{
    ...
    *mlen = smlen - SPX_BYTES;
    ...
    CSR_READ(CSR_REG_MCYCLE, &cycles_function);
    printf("crypto_sign_open memmove cycles: %u\n", cycles_function);
