...
// Design Name:  SLH-DSA gen_chain — Power Characterization
// Language:     C
// Date:         April 2026
//
// Description:  Power-characterization test for the SLH-DSA WOTS+ gen_chain hash-chain
//               routine.
